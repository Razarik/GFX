...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Material bronze = new Material(new Colour(0, 0, 0), new Colour(0.714, 0.4284, 0.18144), new Colour(0.393548, 0.271906, 0.166721), 25.6, new Colour(0.2125, 0.1275, 0.054));
        ...
        //bigCube.transform(tf.translate(0, 0, 0).multiply(tf.scale(20, 20, 20)), tf.inverseScale(20, 20, 20).multiply(tf.inverseTranslate(0, 0, 0)));
        //objects.add(bigCube);
        ...
        //Plane test = new Plane((copper));
        //test.transform(tf.scale(50, 50, 50), tf.inverseScale(50, 50, 50));
        //objects.add(test);
        //objects.add(new Square(copper));
        ...
        lights.add(light2);
        LightSource light3 = new LightSource(new Point(0, 10, -3), new Colour(1, 1, 1));
        lights.add(light3);
        ...
        for (int column = 0; column < width; column++) {
            for (int row = 0; row < height; row++) {
                ...
                for (Intersection intersection : intersections) {
                    if ((bestIntersection == null && intersection.getHitTime() > 0) || (intersection.getHitTime() > 0 && intersection.getHitTime() < bestIntersection.getHitTime())) {
